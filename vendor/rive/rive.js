        ...
        var RuntimeLoader = /** @class */ (function () {
          ...
          RuntimeLoader.loadRuntime = function () {
            ...
            _rive_advanced_mjs__WEBPACK_IMPORTED_MODULE_0__["default"](__assign({
              // Loads Wasm bundle
              locateFile: function () { return attemptedUrl; }
            ...
            function (moduleArg = {}) {
              ...
              var Yc = (a, b) => {
                ...
                name: "emscripten::val", fromWireType: a => {
                  ...
                  ad(a);
                  return b;
                }, toWireType: (a, b) => ac(b), argPackAdvance: 8, readValueFromPointer: yc, L: null,
              }, cd = (a, b, c) => {
                switch (b) {
                  case 1:
                    return c ? function (d) {
              ...
              var Td = (a, b) => {
                ...
                m = {
                  "%a": n => v[n.R].substring(0, 3), "%A": n => v[n.R], "%b": n => x[n.Ia].substring(0, 3), "%B": n => x[n.Ia], "%C": n => f((n.ca + 1900) / 100 | 0, 2), "%d": n => f(n.Va, 2), "%e": n => e(n.Va, 2, " "), "%g": n => p(n).toString().substring(2), "%G": p, "%H": n => f(n.Ha, 2), "%I": n => {
                    n = n.Ha;
                    0 == n ? n = 12 : 12 < n && (n -= 12);
                    return f(n, 2);
                  }, "%j": n => {
                ...
                __syscall_fcntl64: function (a, b, c) {
                  ...
                  T([a], f, g => {
                    ...
                    e.forEach((p, m) => {
                      ...
                      k[p.Mb] = {
                        read: z => t.fromWireType(v(x, z)), write: (z, A) => {
                          var C = [];
                  ...
                  e.values = {};
                  S(a, {
                    name: b, constructor: e, fromWireType: function (f) {
                  ...
                  b = R(b);
                  S(a, {
                    Ic: !0, name: b, argPackAdvance: 0, fromWireType: () => {
                    }, toWireType: () => {
                    },
                  });
